...
public final class Root implements WindowListener, ListSelectionListener, SelectionChangedListener {
	...
	public void selectToolPlace() {
		...
		this.canvas.activeCursor = GraphicsTools.getCursor("pneditor/canvas/place.gif", new Point(16, 16));
		this.canvas.setCursor(this.canvas.activeCursor);
		repaintCanvas();
	}
	...
	public void selectToolTransition() {
		...
		this.canvas.activeCursor = GraphicsTools.getCursor("pneditor/canvas/transition.gif", new Point(16, 16));
		this.canvas.setCursor(this.canvas.activeCursor);
		repaintCanvas();
	}
	...
	public void selectToolArc() {
		...
		this.canvas.activeCursor = GraphicsTools.getCursor("pneditor/canvas/arc.gif", new Point(0, 0));
		this.canvas.setCursor(this.canvas.activeCursor);
		repaintCanvas();
	}
	...
	public void selectToolToken() {
		...
		this.canvas.activeCursor = GraphicsTools.getCursor("pneditor/canvas/token_or_fire.gif", new Point(16, 0));
		this.canvas.setCursor(this.canvas.activeCursor);
		repaintCanvas();
	}
